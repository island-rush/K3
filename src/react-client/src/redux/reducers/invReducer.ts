//prettier-ignore
import {INITIAL_GAMESTATE,SHOP_TRANSFER,PIECE_PLACE,RODS_FROM_GOD_SELECTED,REMOTE_SENSING_SELECTED,INSURGENCY_SELECTED,BIO_WEAPON_SELECTED,RAISE_MORALE_SELECTED,COMM_INTERRUP_SELECTED,GOLDEN_EYE_SELECTED} from "../actions/actionTypes";
