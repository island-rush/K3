//prettier-ignore
import {INITIAL_GAMESTATE,SET_USERFEEDBACK,SHOP_REFUND,SHOP_PURCHASE,SHOP_TRANSFER,START_PLAN,CANCEL_PLAN,DELETE_PLAN,PLAN_WAS_CONFIRMED,MAIN_BUTTON_CLICK,PURCHASE_PHASE,COMBAT_PHASE,SLICE_CHANGE,NEWS_PHASE,NEW_ROUND,PLACE_PHASE,PIECES_MOVE,BATTLE_PIECE_SELECT,TARGET_PIECE_SELECT,ENEMY_PIECE_SELECT,MENU_SELECT,NO_MORE_EVENTS,BATTLE_FIGHT_RESULTS,EVENT_BATTLE,EVENT_REFUEL,AIRCRAFT_CLICK,RODS_FROM_GOD_SELECTING,RODS_FROM_GOD_SELECTED,REMOTE_SENSING_SELECTING,REMOTE_SENSING_SELECTED,INSURGENCY_SELECTED,INSURGENCY_SELECTING,BIO_WEAPON_SELECTED,BIO_WEAPON_SELECTING,RAISE_MORALE_SELECTING,RAISE_MORALE_SELECTED,COMM_INTERRUPT_SELECTING,COMM_INTERRUP_SELECTED,UPDATE_FLAGS,GOLDEN_EYE_SELECTED,GOLDEN_EYE_SELECTING,PIECE_OPEN_ACTION,PIECE_CLOSE_ACTION,OUTER_PIECE_CLICK_ACTION,INNER_PIECE_CLICK_ACTION,INNER_TRANSPORT_PIECE_CLICK_ACTION} from "../actions/actionTypes";
