...
export let FLAG_ISLAND_OWNERSHIP: { [id: number]: number } = {};
...
export let ISLAND_POSITIONS: { [id: number]: number[] } = {};
//prettier-ignore
...
export let TEAM_MAIN_ISLAND_STARTING_POSITIONS: { [id: number]: number[] } = {};
