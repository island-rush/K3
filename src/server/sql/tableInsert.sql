...
CREATE TABLE IF NOT EXISTS games (
    ...
    airfield0 INT(1) NOT NULL DEFAULT 0, -- Dragon bottom
    airfield1 INT(1) NOT NULL DEFAULT 0, -- Dragon top
    airfield2 INT(1) NOT NULL DEFAULT 0, -- HR Republic
    airfield3 INT(1) NOT NULL DEFAULT 0, -- Montaville
    airfield4 INT(1) NOT NULL DEFAULT 0, -- Lion
    airfield5 INT(1) NOT NULL DEFAULT 0, -- Fuller
    airfield6 INT(1) NOT NULL DEFAULT 0, -- Rico
    airfield7 INT(1) NOT NULL DEFAULT 0, -- Keoni
