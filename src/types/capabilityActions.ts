...
export type RaiseMoraleRequestAction = {
    ...
    payload: {
        selectedCommanderType: typeof TYPE_MAIN | typeof TYPE_AIR | typeof TYPE_LAND | typeof TYPE_SEA | typeof TYPE_SPECIAL;
        invItem: InvItemType;
    };
};
