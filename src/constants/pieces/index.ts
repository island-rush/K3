...
export const AIRFIELD_CAPTURE_TYPES = [ARMY_INFANTRY_COMPANY_TYPE_ID, MARINE_INFANTRY_COMPANY_TYPE_ID, SOF_TEAM_TYPE_ID];
...
// export const SAM_AUTO_ATTACK_HIT_CHANCE = 70; // value out of 100 (percent)
