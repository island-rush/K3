...
sam[ARMY_INFANTRY_COMPANY_TYPE_ID] = -1;
sam[ARTILLERY_BATTERY_TYPE_ID] = -1;
sam[TANK_COMPANY_TYPE_ID] = -1;
sam[MARINE_INFANTRY_COMPANY_TYPE_ID] = -1;
sam[ATTACK_HELICOPTER_TYPE_ID] = 2;
sam[LIGHT_INFANTRY_VEHICLE_CONVOY_TYPE_ID] = -1;
sam[SAM_SITE_TYPE_ID] = 0;
sam[DESTROYER_TYPE_ID] = -1;
sam[A_C_CARRIER_TYPE_ID] = -1;
sam[SUBMARINE_TYPE_ID] = -1;
sam[TRANSPORT_TYPE_ID] = -1;
sam[MC_12_TYPE_ID] = 1;
sam[C_130_TYPE_ID] = 2;
sam[SOF_TEAM_TYPE_ID] = -1;
sam[RADAR_TYPE_ID] = -1;
sam[MISSILE_TYPE_ID] = -1;
