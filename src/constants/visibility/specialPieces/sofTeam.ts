...
sofTeam[BOMBER_TYPE_ID] = -1;
sofTeam[STEALTH_BOMBER_TYPE_ID] = -1;
sofTeam[STEALTH_FIGHTER_TYPE_ID] = -1;
sofTeam[AIR_REFUELING_SQUADRON_ID] = -1;
sofTeam[TACTICAL_AIRLIFT_SQUADRON_TYPE_ID] = -1;
sofTeam[AIRBORN_ISR_TYPE_ID] = -1;
