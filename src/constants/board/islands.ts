...
ISLAND_POINTS[DRAGON_ISLAND_ID] = 30;
ISLAND_POINTS[HR_REPUBLIC_ISLAND_ID] = 10;
ISLAND_POINTS[MONTAVILLE_ISLAND_ID] = 18;
ISLAND_POINTS[LION_ISLAND_ID] = 12;
ISLAND_POINTS[NOYARC_ISLAND_ID] = 14;
ISLAND_POINTS[FULLER_ISLAND_ID] = 16;
ISLAND_POINTS[RICO_ISLAND_ID] = 15;
ISLAND_POINTS[TAMU_ISLAND_ID] = 12;
ISLAND_POINTS[SHOR_ISLAND_ID] = 10;
ISLAND_POINTS[KEONI_ISLAND_ID] = 18;
ISLAND_POINTS[EAGLE_ISLAND_ID] = 45;
...
export const TEAM_MAIN_ISLAND_STARTING_POSITIONS: { [id: number]: number[] } = {};

// prettier-ignore
TEAM_MAIN_ISLAND_STARTING_POSITIONS[RED_TEAM_ID] = [...ISLAND_POSITIONS[DRAGON_ISLAND_ID], 8, 9, 23, 37, 50, 61, 62, 63, 74, 81, 82, 88, 98, 104, 116, 120, 121, 133, 134, 135, 136];
// prettier-ignore
...
export const ALL_LAND_POSITIONS = [
    ...
    ...ISLAND_POSITIONS[MONTAVILLE_ISLAND_ID],
    ...ISLAND_POSITIONS[LION_ISLAND_ID],
    ...ISLAND_POSITIONS[NOYARC_ISLAND_ID],
    ...ISLAND_POSITIONS[FULLER_ISLAND_ID],
    ...ISLAND_POSITIONS[RICO_ISLAND_ID],
    ...ISLAND_POSITIONS[TAMU_ISLAND_ID],
    ...ISLAND_POSITIONS[SHOR_ISLAND_ID],
    ...ISLAND_POSITIONS[KEONI_ISLAND_ID],
